...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/hairstyles/type/braids`,          lastModified: new Date(), changeFrequency: "weekly",  priority: 0.7 },
    { url: `${base}/hairstyles/type/buns`,            lastModified: new Date(), changeFrequency: "weekly",  priority: 0.7 },
    { url: `${base}/hairstyles/type/waves`,           lastModified: new Date(), changeFrequency: "weekly",  priority: 0.7 },
    { url: `${base}/hairstyles/type/curls`,           lastModified: new Date(), changeFrequency: "weekly",  priority: 0.7 },
    { url: `${base}/hairstyles/occasion/everyday`,    lastModified: new Date(), changeFrequency: "weekly",  priority: 0.7 },
    { url: `${base}/hairstyles/occasion/wedding`,     lastModified: new Date(), changeFrequency: "weekly",  priority: 0.7 },
    { url: `${base}/hairstyles/occasion/party`,       lastModified: new Date(), changeFrequency: "weekly",  priority: 0.7 },
    { url: `${base}/hairstyles/occasion/office`,      lastModified: new Date(), changeFrequency: "weekly",  priority: 0.7 },
    { url: `${base}/accessories`,                      lastModified: new Date(), changeFrequency: "weekly",  priority: 0.8 },
    { url: `${base}/accessories/type/bags`,           lastModified: new Date(), changeFrequency: "weekly",  priority: 0.7 },
    { url: `${base}/accessories/type/jewelry`,        lastModified: new Date(), changeFrequency: "weekly",  priority: 0.7 },
    { url: `${base}/accessories/type/shoes`,          lastModified: new Date(), changeFrequency: "weekly",  priority: 0.7 },
    { url: `${base}/accessories/type/scarves`,        lastModified: new Date(), changeFrequency: "weekly",  priority: 0.7 },
