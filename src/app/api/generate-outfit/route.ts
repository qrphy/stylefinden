// Outfit için açıklama ve etiket üreten API endpoint'i.
// Mevcut döküman alanlarını (başlık, stil, mevsim, ortam) alır,
// kısa bir Portable Text açıklaması ve etiket seti döner.
...
// Gelen isteği doğrulayan şema — yalnızca title zorunlu, diğerleri opsiyonel
...
export async function POST(req: Request) {
  ...
  // Mevcut döküman alanlarını prompt'a ek bağlam olarak ekle
  const details = [
    style && `Style: ${style}`,
