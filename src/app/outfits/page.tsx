...
const collections: CollectionGroup[] = [
  {
    ...
    items: [
      ...
      { slug: "spring", label: "Spring Looks",   description: "Pastel tones, light blazers and fresh combinations",              tags: ["Pastels", "Blazer", "Linen", "Floral"],  badge: "New", accent: "bg-[#e8f5e9]", accentText: "text-[#2e7d32]", active: true, sizes: "(max-width: 768px) 100vw, (max-width: 1280px) 50vw, 25vw" },
    ],
  },
  {
    label: "By Occasion",
